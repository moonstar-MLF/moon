...
{
	ofstream ofs(_T("E:\\那些上网课的痛苦日子\\Visual C++\\20200427实验\\学生名单.txt"));
	for (int i = 1; i <= count; i++)
	{
		ofs << CT2A(ca.GetAt(i)) << endl;
	}
}
...
BOOL CMFCApplication1Dlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
	CString filename = _T("E:\\那些上网课的痛苦日子\\Visual C++\\20200427实验\\学生名单.txt");
	ifstream ifs(filename);//将输入流与文件建立联系（学生名单.txt）
	string s;
	int i = 0;
	ca.SetSize(100);
